...
## 📹 Pílula de Vídeo Docente Inline: Digital Twins en Aspen Plus

::: {.video-player-wrapper}
::: {.video-header-bar}
<span class="video-title">🎥 Pílula de Vídeo 1.1: Introdución aos Digital Twins e Automatización Python-COM</span>
<span class="badge bg-sky-600 text-white font-bold text-xs px-2.5 py-1 rounded-full">1080p HD Inline</span>
:::

<video controls poster="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=1200&q=80" preload="metadata" class="w-100">
...
:::
::: {.audio-info}
<h4 class="audio-title">Podcast Técnico NotebookLM: Digital Twins en Enxeñaría Química</h4>
<p class="audio-sub">Resumo en formato de diálogo profundizando nos retos de sincronización de datos de planta.</p>
:::
:::
